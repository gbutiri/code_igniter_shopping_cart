	...
	<body class="hold-transition login-page">
		<div class="login-box">
			<div class="login-logo">
				<a href="../../index2.html"><b>CI</b>Core</a>
			</div><!-- /.login-logo -->
			<div class="login-box-body">
				<p class="login-box-msg">Unable to retrieve account.</p>
				<p class="login-box-msg">The token could be invalid, or user may not exist.</p>
